...
export declare type ShapeObjType = typeof Types['number'] | typeof Types['boolean'] | {
...
export declare function translateFunction<T extends unknown[]>(func: (...args: T) => void, types: FunctionType[], shapes: unknown[], functions: SimpleFunctionType[]): string;
