...
argumentHandlers.set('Object', (name) => {
    ...
    if (param.name !== 'object')
        throw new Error('Object argument must be an object');
...
function handleArgType(name, type) {
    var _a;
    return ((_a = argumentHandlers.get(type.type)) !== null && _a !== void 0 ? _a : (() => {
...
function prefixFunction(c) {
    ...
    if (c.startsWith('(function('))
        return c;
    if (c.startsWith('('))
        return `(function ${c.slice(1, c.length)}`;
    else
        return `function ${c}`;
}
    ...
    if (st.type === 'ExpressionStatement' && st.expression.type === 'FunctionExpression') {
        const fucts = functions
            ...
            if (pf.type === 'FunctionDeclaration') {
                const name = (_a = f.name) !== null && _a !== void 0 ? _a : (_b = pf.id) === null || _b === void 0 ? void 0 : _b.name;
                if (name == null)
                    throw new Error('Declared function must have name or identifier');
                const shape = /*f.shape ??*/ (_d = (_c = f.shapeObj) === null || _c === void 0 ? void 0 : _c.map((obj) => objSerializer.serializeObject(obj, false)[0])) === null || _d === void 0 ? void 0 : _d.map((obj) => {
        ...
        const params = st.expression.params
            ...
            if (p.type === 'Identifier') {
                ...
                const tp = param !== null && param !== void 0 ? param : (types[idx].type === 'Float32Array' || types[idx].type === 'Float64Array'
                    ? { name: 'array', contentType: { name: 'double' } }
                    : null !== null && null !== void 0 ? null : { name: 'int' });
