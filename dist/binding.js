...
exports.KernelContext =
  exports.Gpgpu =
  exports.DeviceType =
  exports.kernelEntry =
  exports.kernelFunction =
  exports.Types =
    void 0;
const parser_1 = require('./parser');
Object.defineProperty(exports, 'KernelContext', {
  enumerable: true,
  get: function () {
    return parser_1.KernelContext;
  },
});
...
class Gpgpu {
  ...
  createFuncKernel(types, func, opt) {
    ...
    const kernel = this._addonInstance.createKernel(
      (0, parser_1.translateFunction)(
        func,
        types,
        types.flatMap((ft) => (ft.type === 'Object' || ft.type === 'Object[]' ? [ft.shapeObj] : [])),
        (_a = opt === null || opt === void 0 ? void 0 : opt.functions) !== null && _a !== void 0 ? _a : [],
      ),
      types.map((t) => t.type),
